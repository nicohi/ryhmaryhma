...
public class TextUICommands {
    ...
    public static class UpdateRead implements Command {
        ...
        public void run(Textui ui, String... args) {
            ...
            boolean boolread = read.toLowerCase().equals("y");
            ui.getController().markRead(boolread, title);
        }

        @Override
        public String help() {
            return "read - mark a tip as read or not read";
        }
